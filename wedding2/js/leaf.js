(function () {
  ...
  const colors = ['#EF4444', '#F43F5E', '#FB7185', '#EC4899', '#D946EF', '#F59E0B'];
  ...
  function createLeaf() {
    ...
    fallLayer.addEventListener('animationiteration', () => {
      ...
      leaf.style.setProperty('--opacity', rand(.7,1));
    });
  ...
  // render N trái tim
  const COUNT = 30; // chỉnh số lượng tại đây
